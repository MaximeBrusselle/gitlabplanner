...
CREATE TABLE `__new_organization_members` (
	...
	`created_at` text DEFAULT '2024-12-16T15:28:03.189Z' NOT NULL,
...
CREATE TABLE `__new_users` (
	...
	`email` text NOT NULL,
	`image_url` text,
	`created_at` text DEFAULT '2024-12-16T15:28:03.188Z' NOT NULL,
	`last_sign_in` text DEFAULT '2024-12-16T15:28:03.188Z' NOT NULL
);
--> statement-breakpoint
